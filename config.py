...
class Config:
    ...
    OWNER_ID = int(os.environ.get("OWNER_ID", 1548967589))
...
👥 **Support Group:** [SafoTheBot](https://t.me/SDBOTz)

📢 **Updates Channel:** [SDBOTs](https://t.me/SDBOTs_Inifinity)
"""
